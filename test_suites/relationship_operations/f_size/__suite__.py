name = "Graph Size (E)"
description = "Edge Ingestion as a function of graph size."
...
for g in graph_size:
    if 1:
        cases.append({
            "name":"ingest",
            "description":"Edge Ingestion as a function of graph size (threads=%d,txsize=%d,page_size=%d)."%(threads,txsize,pow(2,page_size)),
            "type":"graph_v_ingest",
            "data":
            {
                "graph_size":[g],
    ...
    cases.append({
        "name":"navigate",
        "description":"Navigation as a function of graph size (txsize=%d,page_size=%d)"%(txsize,pow(2,page_size)),
        "type":"graph_v_search",
        "data":
        {
            "graph_size":[g],
    ...
    cases.append({
        "name":"navigate",
        "description":"Navigate as a function of graph size (txsize=%d,page_size=%d)"%(txsize,pow(2,page_size)),
        "type":"graph_v_search",
        "data":
        {
            "graph_size":[g],
