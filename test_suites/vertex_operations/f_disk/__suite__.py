name = "Disk"
description = "Vertex Ingestion/Search as a function of nunmber of disks used."
...
for engine in ["ig2","ig3"]:
    ...
    cases.append({
        "name":"search",
        "description":"Indexed Vertex Search as a function of cache size,  search size set and threads (graph_size=%d,txsize=%d,page_size=%d)"%(graph_size[0],txsize,pow(2,page_size)),
        "type":"graph_v_search",
        "data":
        {
            "graph_size":graph_size,
